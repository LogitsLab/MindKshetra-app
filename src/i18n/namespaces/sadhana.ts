...
export const en = {
  ...
  japaSetupIntro: "Choose a mantra or a name, how many times, and whether a recorded chant plays with you.",
  ...
  japaModeSelf: "Self",
  japaModeAssistedHint: "A recorded recitation plays each time you tap the mala.",
  ...
  japaModeSelfHint: "Count in silence. No voice.",
  japaAssistedMuted: "Silent count — no recording for this mantra",
  japaAssistedPlaying: "Chant playing",
  japaAssistedReady: "Tap to hear the chant",
  japaBegin: "Begin japa",
  japaOfTarget: "of {n}",
  japaTargetDone: "This round is complete.",
  japaRound: "Round {n}",
  japaKeepGoing: "Keep going, or finish when ready.",
  japaDailyToday: "Today {n} / {goal} beads",
  japaDailyGoalMet: "Daily goal met · {n} beads",
  japaLifetime: "{beads} beads · {malas} malas so far",
  japaChangeSetup: "Change setup",
  japaPreview: "Preview recitation",
  japaNoChant: "No recording",
  japaNewRound: "Begin another round",
  japaSetupDone: "Done",
  homeSadhanaEyebrow: "Daily practice",
  homeSadhanaTitle: "Begin today’s sādhana",
  homeSadhanaName: "Sādhana",
  homeSadhanaBody: "A verse, a short sit, one quiet line",
  homeSadhanaDone: "Done for today",
  homeSadhanaCta: "Begin",
...
export const hi: Record<keyof typeof en, string> = {
  ...
  japaSetupIntro: "मंत्र या नाम चुनें, कितनी बार जपना है, और रिकॉर्ड की गई आवाज़ साथ देगी या मौन रहेगी।",
  ...
  japaModeSelf: "स्वयं",
  japaModeAssistedHint: "माला छूने पर रिकॉर्ड किया हुआ पाठ चलेगा।",
  japaModeAssistedNoneHint:
    "इस मंत्र की खुली रिकॉर्डिंग नहीं है — मौन में गिनें।",
  japaChantCredit: "विकिमीडिया कॉमन्स और जैमेन्डो से मानव पाठ।",
  japaModeSelfHint: "मौन में गिनें। कोई आवाज़ नहीं।",
  japaAssistedMuted: "मौन गणना — इस मंत्र की रिकॉर्डिंग नहीं है",
  japaAssistedPlaying: "पाठ चल रहा है",
  japaAssistedReady: "पाठ सुनने के लिए छुएँ",
  japaBegin: "जप आरंभ करें",
  japaOfTarget: "{n} में से",
  japaTargetDone: "यह चक्र पूर्ण हुआ।",
  japaRound: "चक्र {n}",
  japaKeepGoing: "जारी रखें, या तैयार होने पर समाप्त करें।",
  japaDailyToday: "आज {n} / {goal} मनके",
  japaDailyGoalMet: "दैनिक लक्ष्य पूर्ण · {n} मनके",
  japaLifetime: "{beads} मनके · {malas} माला अब तक",
  japaChangeSetup: "सेटअप बदलें",
  japaPreview: "पाठ सुनें",
  japaNoChant: "रिकॉर्डिंग नहीं",
  japaNewRound: "एक और चक्र आरंभ करें",
  japaSetupDone: "हो गया",
  homeSadhanaEyebrow: "दैनिक अभ्यास",
  homeSadhanaTitle: "आज की साधना आरंभ करें",
  homeSadhanaName: "साधना",
  homeSadhanaBody: "एक श्लोक, एक छोटी बैठक, एक शांत पंक्ति",
  homeSadhanaDone: "आज पूर्ण हुआ",
  homeSadhanaCta: "आरंभ करें",
  homeTodayEyebrow: "आज",
