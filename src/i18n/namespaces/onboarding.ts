export const en = {
  ...
  onboardingLangBody:
    "Pick how you’d like to read verses, meanings, and the app itself. You can change this anytime in Profile.",
...
export const hi: Record<keyof typeof en, string> = {
  ...
  onboardingLangBody:
    "श्लोक, अर्थ और ऐप किस भाषा में दिखें — चुनें। बाद में प्रोफ़ाइल से बदल सकते हैं।",
  onboardingLangEn: "English",
  onboardingLangHi: "हिंदी",
  onboardingLangPreviewEn: "The field of the mind awaits.",
  onboardingLangPreviewHi: "मन का क्षेत्र आपका इंतज़ार कर रहा है।",
